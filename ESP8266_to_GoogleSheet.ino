...
const char* ssid = "Thun_2.4G";  	// Your wifi name
const char* password = "abcdefabcd"; 	// Your wifi password

// Google script ID.
String Script_ID = "AKfycby5EP0u05bMiIT4ZwBR2F-QgdjeD-oYKIHQ8ubK6civ4ChB_996b0cw-dHSNuwrV6nkaA";
...
void loop() {
  ...
  String Send_Data_URL = "/macros/s/" + Script_ID + "/exec?sts=write";
